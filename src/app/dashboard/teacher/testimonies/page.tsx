...
export default function TeacherTestimoniesPage() {
  const { user } = useAuth();
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          Help prospective students and parents by sharing your insights about the school. Your feedback will be reviewed before being published.
        </p>
      </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="program">Testimony Target</Label>
                    <Select value={selectedProgram} onValueChange={setSelectedProgram}>
                      <SelectTrigger id="program">
                        <SelectValue placeholder="General or program" />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="year">Teaching Since</Label>
                    <Input
                      id="year"
                      value={formData.year}
                      onChange={(e) =>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Share your experience working at the school, what makes it special, your achievements, or advice for parents and students..."
                    rows={6}
                  />
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex-1">
                        ...
                        <div className="flex gap-4 text-xs text-gray-500">
                          ...
                          {testimony.year && <span>📅 Since {testimony.year}</span>}
                          <span>
                            ⭐ {testimony.rating}/5
                          </span>
                          <span>
